...
public class NewGroupActivity extends BaseActivity {
    ...
    public void save(View v) {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            startActivityForResult(new Intent(this, GroupPickContactsActivity.class).putExtra("groupName", name), I.REQUESTCODE_MEMOBER);
        }
    }
    ...
    private void createEMGroup(final Intent data) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                L.e(TAG, "members=" + members.toString());
                try {
    ...
    @OnClick({R.id.layout_groupIcon, R.id.cb_public, R.id.cb_member_inviter})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.layout_groupIcon:
                uploadHeadPhoto();
                break;
            case R.id.cb_public:
                break;
